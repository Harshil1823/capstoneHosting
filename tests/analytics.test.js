...
describe('Analytics Controller', () => {
    ...
    describe('getTodayCompanyAnalytics', () => {
        it('should return today\'s analytics for a company', async () => {
            ...
            // Mock Analytics.findOne to return the chain
            Analytics.findOne = jest.fn().mockReturnValue(mockChain);
            
            // Call the function
            const result = await analyticsController.getTodayCompanyAnalytics(mockCompanyId);
            
            // Verify the result
            expect(result).toBe(mockAnalytics);
        });
        
        it('should create analytics if none exist for today', async () => {
            // Create a mock for the chain that returns null (no analytics found)
            const mockChain = {
            populate: jest.fn().mockReturnThis(),
            ...
            // Create a similar chain for findById
            ...
            // Mock Analytics.findById
            Analytics.findById = jest.fn().mockReturnValue(mockFindByIdChain);
